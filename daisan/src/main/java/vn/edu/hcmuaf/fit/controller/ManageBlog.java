...
@WebServlet(name = "/ManageBlog", urlPatterns = "/ManageBlog")
public class ManageBlog extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<BlogBean> listBlogAdmin = new ArrayList<>();
        ...
        try {
            ...
            session.setAttribute("listBlogAdmin",listBlogAdmin);

            request.getRequestDispatcher("admin/quanliblog.jsp").forward(request,response);
