    ...
    public BlogService(){
       ...
       public void Blog(){
           try {
               ...
               PreparedStatement ps = ConnectionDB.conn.prepareStatement("select blog.*,blogdetail.content from blog,blogdetail where blog.blogid = blogdetail.blogid");
               ...
               while (rs.next()){
                   ...
                   PreparedStatement ps1 = ConnectionDB.conn.prepareStatement("select name from user where id = ?");
