...
public class Home extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement statement1 = ConnectionDB.con.prepareStatement(sql1);
            ...
            PreparedStatement statement3 = ConnectionDB.con.prepareStatement(sql3);
            ...
            PreparedStatement statement4 = ConnectionDB.con.prepareStatement(sql4);
            ...
            PreparedStatement statement5 = ConnectionDB.con.prepareStatement(sql5);
            ...
            PreparedStatement statement6 = ConnectionDB.con.prepareStatement(sql6);
            ...
            PreparedStatement statement7 = ConnectionDB.con.prepareStatement(sql7);
            ...
            PreparedStatement statement8 = ConnectionDB.con.prepareStatement(sql8);
