...
//            while (rs.next()) {
//                listProducts.add( new ProductBean(rs.getInt(1),rs.getString(2),rs.getString(3),rs.getInt(4),rs.getInt(5),rs.getString(6),rs.getInt(7),rs.getString(8),rs.getInt(9)));
//            }
...
//            while (rs1.next()) {
//                listProducts1.add( new ProductBean(rs1.getInt(1),rs1.getString(2),rs1.getString(3),rs1.getInt(4),rs1.getInt(5),rs1.getString(6),rs1.getInt(7),rs1.getString(8),rs1.getInt(9)));
//            }
...
//            while (rs2.next()) {
//                listProducts2.add( new ProductBean(rs2.getInt(1),rs2.getString(2),rs2.getString(3),rs2.getInt(4),rs2.getInt(5),rs2.getString(6),rs2.getInt(7),rs2.getString(8),rs2.getInt(9)));
//            }
...
//            while (rs3.next()) {
//                listProducts3.add( new ProductBean(rs3.getInt(1),rs3.getString(2),rs3.getString(3),rs3.getInt(4),rs3.getInt(5),rs3.getString(6),rs3.getInt(7),rs3.getString(8),rs3.getInt(9)));
//            }
//            request.setAttribute("Data3",listProducts3);
//            PreparedStatement statement4 = ConnectionDB.conn.prepareStatement(sql4);
//            ResultSet rs4 = statement4.executeQuery();
//            while (rs4.next()) {
//                listProducts4.add( new ProductBean(rs4.getInt(1),rs4.getString(2),rs4.getString(3),rs4.getInt(4),rs4.getInt(5),rs4.getString(6),rs4.getInt(7),rs4.getString(8),rs4.getInt(9)));
//            }
...
//            while (rs5.next()) {
//                listProducts5.add( new ProductBean(rs5.getInt(1),rs5.getString(2),rs5.getString(3),rs5.getInt(4),rs5.getInt(5),rs5.getString(6),rs5.getInt(7),rs5.getString(8),rs5.getInt(9)));
//            }
...
//            while (rs6.next()) {
//                listProducts6.add( new ProductBean(rs6.getInt(1),rs6.getString(2),rs6.getString(3),rs6.getInt(4),rs6.getInt(5),rs6.getString(6),rs6.getInt(7),rs6.getString(8),rs6.getInt(9)));
//            }
...
//            while (rs7.next()) {
//                listProducts7.add( new ProductBean(rs7.getInt(1),rs7.getString(2),rs7.getString(3),rs7.getInt(4),rs7.getInt(5),rs7.getString(6),rs7.getInt(7),rs7.getString(8),rs7.getInt(9)));
//            }
...
//            while (rs8.next()) {
//                listProducts8.add( new ProductBean(rs8.getInt(1),rs8.getString(2),rs8.getString(3),rs8.getInt(4),rs8.getInt(5),rs8.getString(6),rs8.getInt(7),rs8.getString(8),rs8.getInt(9)));
//            }
