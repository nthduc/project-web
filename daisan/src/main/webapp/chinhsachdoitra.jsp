...
<head>
    ...
    <title>DAISAN | Chính Sách Đổi Trả</title>
                ...
                <div class="yamm navbar navbar-default" role="navigation">
                    <div class="navbar-header">
                        <button data-target="#mc-horizontal-menu-collapse" data-toggle="collapse"
                            ...
                            <span class="sr-only">Chuyển Điều Hướng</span> <span class="icon-bar"></span>
                        ...
                        <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                            <div class="nav-outer">
                                <ul class="nav navbar-nav">
                                    <li class="active dropdown yamm-fw"> <a href="home.html">Trang chủ</a>
                                    </li>
                                                    ...
                                                    <div class="row">
                                                        <div
                                                            ...
                                                            <ul class="links">
                                                                ...
                                                                <li><a href="#">Gạch sân vườn, vỉa hè </a>
                                                                </li>
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="links">
                                                                ...
                                                                <li><a href="#">Bột bả và chống thấm</a>
                                                                </li>
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="links">
                                                                ...
                                                                <li><a href="#">Tấm panel, vách ngăn</a>
                                                                </li>
                                                        ...
                                                        <div
                                                                class="col-xs-12 col-sm-6 col-md-2 col-menu  drop-height">
                                                            <h2 class="title">Cửa & cửa sổ. bán lẻ & phụ
                                                                kiện</h2>
                                                            <ul class="links">
                                                        ...
                                                        <div
                                                            ...
                                                            <img class="img-responsive"
                                                                 src="assets/images/sliders/slider3.png"
                                                                 alt="logo"
...
<div style="padding: 25px 120px">
    <div style="padding: 10px 180px;" data-content-type="row" data-appearance="contained" data-element="main">
        <div class="container-680" data-enable-parallax="0" data-parallax-speed="0.5" data-background-images="{}"
            ...
            <h1>Chính sách đổi trả & hủy đơn hàng</h1>
            <h3></h3>
            <hr>
            <div id="hcdetail">
                <p><strong>Daisan</strong> không phải là người cung cấp sản phẩm/ dịch vụ nên việc đổi trả sản phẩm/
                    dịch vụ
                    sẽ được thực hiện theo chính sách của từng Nhà bán hàng.</p>
                <p><strong>Daisan </strong>yêu cầu Nhà bán hàng khi đăng tin trên website bán hàng phải đưa đầy đủ
                    thông tin
                    về chính sách đổi trả hàng.</p>
                <p>Khi hàng được vận chuyển và giao đến, Người mua hàng hoàn tất việc thanh toán, ký xác nhận với
                    nhân viên
                    giao hàng
                    và kiểm tra xem sản phẩm có lỗi nào không. <strong>Daisan </strong>khuyến cáo Người mua hàng nên
                    giữ lại
                    biên lai vận chuyển để kiểm tra, đối chiếu.</p>
                <p>Ngoài ra, Người mua hàng toàn quyền thỏa thuận với Nhà bán hàng về phương thức giao hàng (giao
                    trực tiếp
                    hoặc gửi qua bưu điện) đối với món hàng mình đã đặt mua.</p>
                <p><strong>Daisan</strong> có trách nhiệm cung cấp thông tin cho Người mua hàng hoặc Nhà bán hàng
                    khi có
                    tranh chấp trong quá trình giao dịch nếu có phát sinh mâu thuẫn xảy ra sau khi giao hàng.</p>
            </div>
        </div>
    </div>
</div>
