      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            <li><a href="thongtintaikhoan.html"><i class="icon fa fa-user"></i>Tài khoản của tôi</a></li>
            ...
            <form>
              <div class="control-group">
                <ul class="categories-filter animate-dropdown">
                  <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="category.html">Danh
                    mục<b class="caret"></b></a>
                    <ul class="dropdown-menu" role="menu">

                      <li role="presentation"><a role="menuitem" tabindex="-1" href="gachoplat.html">- Gạch ốp lát</a>
                      </li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="daoplat.html">- Đá ốp lát</a>
                      </li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="son.html">- Sơn nội thất & ngoại
                        thất</a>
                      </li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="sango.html">- Sàn gỗ và phụ
                        kiện</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="tamoptuong.html">- Tấm ốp
                        tường</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="vatlieutho.html">- Vật liệu
                        thô</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="vattunganhda.html">- Vật tư ngành
                        đá</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Vật liệu mài &
                        phụ kiện</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="cuaso.html">- Cửa & cửa sổ,
                        bản lề & phụ
                        kiện</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="nep.html">- Nẹp</a></li>
                    </ul>
                  </li>
                </ul>
            ...
            <ul class="dropdown-menu">
              <li>
                ...
                <div class="clearfix cart-total">
                  ...
                  <div class="clearfix"></div>
                  <a href="thanhtoan.html" class="btn btn-upper btn-primary btn-block m-t-20">Thanh toán</a>
                </div>
                <!-- /.cart-total-->
    ...
    <div class='row'>
        ...
        <div class="side-menu animate-dropdown outer-bottom-xs">
          ...
          <nav class="yamm megamenu-horizontal">
            <ul class="nav">
              ...
              <li class="dropdown menu-item"> <a href="vatlieumai.html">
              ...
              <li class="dropdown menu-item"> <a href="500.html">Bộ sưu tập Hot</a>
            ...
            <div class="sidebar-widget  wow fadeInUp outer-top-vs ">
              <div id="advertisement" class="advertisement">
                <div class="item">
                  ...
                  <div class="testimonials"><em>"</em> Sản phẩm đẹp, chất lượng, giao hàng nhanh, giống với hình, khá
                    ưng ý, sẽ ủng hộ shop và tin tưởng shop.<em>"</em></div>
      ...
      <div class='col-md-9'>
        ...
        <div id="category" class="category-carousel hidden-xs">
          <div class="item">
            <div class="image"> <img style="filter:brightness(80%);" src="assets/images/banners/gachoptuong.png"
                ...
                <div class="lbl-cnt"> <span class="lbl">Sắp xếp theo</span>
                  <div class="fld inline">
                    <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                      <button data-toggle="dropdown" type="button" class="btn dropdown-toggle"> Mặc định <span
                ...
                <div class="row">
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="chitietsanpham.html"><img
                                  src="assets/images/products/daoplat/p1.jpeg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="chitietsanpham.html">Đá ốp tường BVMV 15x30</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price">138.600đ </span> <span
                                  class="price-before-discount">140.600đ</span> </div>
                          <!-- /.product-price -->
                        ...
                        <div class="cart clearfix animate-effect">
                          <div class="action">
                            <ul class="list-unstyled">
                              ...
                              <li class="lnk wishlist"> <a class="add-to-cart" href="chitietsanpham.html"
                                                           title="Wishlist"> <i class="icon fa fa-heart"></i> </a> </li>
                              <li class="lnk"> <a class="add-to-cart" href="chitietsanpham.html" title="Compare"> <i
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="chitietsanpham.html"><img
                                  src="assets/images/products/daoplat/p2.jpeg"></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="chitietsanpham.html">Đá ghép Nghệ An vàng độ dày 1-1.5cm
                          </a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price">145.000 đ </span> <span
                                  class="price-before-discount"> 188.000 đ</span> </div>
                          <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="product">
                      <div class="product-image">
                        <div class="image"> <a href="chitietsanpham.html"><img
                                src="assets/images/products/daoplat/p3.jpeg" alt=""></a> </div>
                        <!-- /.image -->
                      ...
                      <div class="product-info text-left">
                        <h3 class="name"><a href="chitietsanpham.html">Đá chẻ vàng Nghệ An ốp tường trang trí</a>
                        </h3>
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>
                        <div class="product-price"> <span class="price"> 440,800đ </span> <span
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="product">
                      <div class="product-image">
                        <div class="image"> <a href="chitietsanpham.html"><img
                                src="assets/images/products/daoplat/p4.jpeg" alt=""></a> </div>
                        <!-- /.image -->
                      ...
                      <div class="product-info text-left">
                        <h3 class="name"><a href="chitietsanpham.html">Đá Ghép Đà Nẵng vàng-đen ốp tường trang trí
                          THK-H02</a></h3>
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>
                        <div class="product-price"> <span class="price"> 230.000 đ</span> <span
                                class="price-before-discount">299.000 đ</span> </div>
                        <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="product">
                      <div class="product-image">
                        <div class="image"> <a href="chitietsanpham.html"><img
                                src="assets/images/products/daoplat/p5.jpeg" alt=""></a> </div>
                        <!-- /.image -->
                      ...
                      <div class="product-info text-left">
                        <h3 class="name"><a href="chitietsanpham.html">Đá chẻ đen muối Nghệ An ốp tường trang trí</a>
                        </h3>
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="chitietsanpham.html"><img
                                  src="assets/images/products/daoplat/p6.jpeg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="chitietsanpham.html">Đá ghép Đà Nẵng vàng lai ốp tường trang
                            trí</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> 240.000 đ </span> <span
                                  class="price-before-discount">300.000đ</span> </div>
                          <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="product">
                      <div class="product-image">
                        <div class="image"> <a href="chitietsanpham.html"><img
                                src="assets/images/products/daoplat/p7.jpeg" alt=""></a> </div>
                        <!-- /.image -->
                      ...
                      <div class="product-info text-left">
                        <h3 class="name"><a href="chitietsanpham.html">Đá ong đen, đá ong xám kích thước 5x30x1cm</a>
                        </h3>
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>
                        <div class="product-price"> <span class="price"> 320.850đ </span> <span
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="product">
                      <div class="product-image">
                        <div class="image"> <a href="chitietsanpham.html"><img
                                src="assets/images/products/daoplat/p8.jpeg" alt=""></a> </div>
                        <!-- /.image -->
                      ...
                      <div class="product-info text-left">
                        <h3 class="name"><a href="chitietsanpham.html">Đá Ghép Lai Châu đa sắc ốp tường trang trí</a>
                        </h3>
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>
                        <div class="product-price"> <span class="price"> 4.900.000đ </span> <span
                                class="price-before-discount">5.400.000đ</span> </div>
                        <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="product">
                      <div class="product-image">
                        <div class="image"> <a href="chitietsanpham.html"><img
                                src="assets/images/products/daoplat/p9.jpeg" alt=""></a> </div>
                        <!-- /.image -->
                      ...
                      <div class="product-info text-left">
                        <h3 class="name"><a href="chitietsanpham.html">Đá chẻ đen muối Nghệ An ốp tường trang tríG</a>
                        </h3>
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>
                        <div class="product-price"> <span class="price"> 720.850đ </span> <span
                                class="price-before-discount">860.000đ</span> </div>
                        <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="product">
                      <div class="product-image">
                        <div class="image"> <a href="chitietsanpham.html"><img
                                src="assets/images/products/daoplat/p10.png" alt=""></a> </div>
                        <!-- /.image -->
                      ...
                      <div class="product-info text-left">
                        <h3 class="name"><a href="chitietsanpham.html">Đá mài vát cạnh vàng, đá soi cạnh trang trí sân
                          vườn</a>
                        </h3>
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>
                        <div class="product-price"> <span class="price"> 520.850đ </span> <span
                                class="price-before-discount">570.000đ</span> </div>
                        <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="product">
                      <div class="product-image">
                        <div class="image"> <a href="chitietsanpham.html"><img
                                src="assets/images/products/daoplat/p11.jpeg" alt=""></a> </div>
                        <!-- /.image -->
                      ...
                      <div class="product-info text-left">
                        <h3 class="name"><a href="chitietsanpham.html">Đá an niên bề mặt ANN G04</a>
                        </h3>
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>
                        <div class="product-price"> <span class="price"> 600.850đ </span> <span
                                class="price-before-discount">700.000đ</span> </div>
                        <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="product">
                      <div class="product-image">
                        <div class="image"> <a href="chitietsanpham.html"><img
                                src="assets/images/products/daoplat/p12.jpeg" alt=""></a> </div>
                        <!-- /.image -->
                      ...
                      <div class="product-info text-left">
                        <h3 class="name"><a href="chitietsanpham.html">Đá ong đen ( ít lỗ) ốp lát trang trí nhiều kích
                          thước</a>
                        </h3>
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>
                        <div class="product-price"> <span class="price"> 180.000 đ </span> <span
                                class="price-before-discount">300.000đ</span> </div>
                        <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="product">
                      <div class="product-image">
                        <div class="image"> <a href="chitietsanpham.html"><img
                                src="assets/images/products/daoplat/p13.jpeg" alt=""></a> </div>
                        <!-- /.image -->
                      ...
                      <div class="product-info text-left">
                        <h3 class="name"><a href="chitietsanpham.html">Đá vọng cát bề mặt VOC H03</a>
                        </h3>
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>
                        <div class="product-price"> <span class="price"> 370.850đ </span> <span
                                class="price-before-discount">400.000đ</span> </div>
                        <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="product">
                      <div class="product-image">
                        <div class="image"> <a href="chitietsanpham.html"><img
                                src="assets/images/products/daoplat/p14.jpeg" alt=""></a> </div>
                        <!-- /.image -->
                      ...
                      <div class="product-info text-left">
                        <h3 class="name"><a href="chitietsanpham.html">Đá vọng cát bề mặt VOC H05</a>
                        </h3>
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>
                        <div class="product-price"> <span class="price"> 300.850đ </span> <span
                                class="price-before-discount">400.000đ</span> </div>
                        <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="product">
                      <div class="product-image">
                        <div class="image"> <a href="chitietsanpham.html"><img
                                src="assets/images/products/daoplat/p15.png" alt=""></a> </div>
                        <!-- /.image -->
                      ...
                      <div class="product-info text-left">
                        ...
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>
                        <div class="product-price"> <span class="price"> 380.850đ </span> <span
                                class="price-before-discount">500.000đ</span> </div>
                        <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="product">
                      <div class="product-image">
                        <div class="image"> <a href="chitietsanpham.html"><img
                                src="assets/images/products/daoplat/p16.jpeg" alt=""></a> </div>
                        <!-- /.image -->
                      ...
                      <div class="product-info text-left">
                        <h3 class="name"><a href="chitietsanpham.html">Đá bóc xanh rêu Nghệ An ốp trang trí
                        </a></h3>
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>
                        <div class="product-price"> <span class="price"> 550.850đ </span> <span
                                class="price-before-discount">653.000đ</span> </div>
                        <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="product">
                      <div class="product-image">
                        <div class="image"> <a href="chitietsanpham.html"><img
                                src="assets/images/products/daoplat/p17.jpeg" alt=""></a> </div>
                        <!-- /.image -->
                      ...
                      <div class="product-info text-left">
                        <h3 class="name"><a href="chitietsanpham.html">Đá chẻ trắng muối Nghệ An ốp tường trang
                          trí</a></h3>
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>
                        <div class="product-price"> <span class="price"> 820.000đ </span> <span
                                class="price-before-discount">900.000đ</span> </div>
                        <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="chitietsanpham.html"><img
                                  src="assets/images/products/daoplat/p18.jpeg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="chitietsanpham.html">Đá vọng cát bề mặt VOC H01</a>
                          </h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> 760.000đ </span> <span
                                  class="price-before-discount">970.000đ</span> </div>
                          <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="chitietsanpham.html"><img
                                  src="assets/images/products/daoplat/p19.jpeg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="chitietsanpham.html">Đá Bazan ốp tường</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> 620.000đ </span> <span
                                  class="price-before-discount">700.000đ</span> </div>
                          <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="chitietsanpham.html"><img
                                  src="assets/images/products/daoplat/p20.jpeg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="chitietsanpham.html">Đá an niên bề mặt ANN G01</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price">755.000đ </span> <span
                                  class="price-before-discount">800.000đ</span> </div>
                          <!-- /.product-price -->
