...
<head>
    ...
    <title>DAISAN | Hướng Dẫn Thanh Toán</title>
...
<div style="padding: 25px 120px">
    <div style="padding: 10px 180px;" data-content-type="row" data-appearance="contained" data-element="main">
        <div class="container-680" data-enable-parallax="0" data-parallax-speed="0.5" data-background-images="{}"
            ...
            <hr>
            <div id="hcdetail">
                <p>Khách hàng có thể lựa chọn các phương thức thanh toán trên Sàn TMĐT Daisan bao gồm:</p>
                <p> </p>
                <h3><strong>Cách 1</strong>: Thanh toán trực tiếp (khách hàng nhận hàng tại địa chỉ nhà bán hàng)
                </h3>
                <p>Bước 1: Khách hàng tìm hiều thông tin về sản phẩm trên Daisan.</p>
                <p>Bước 2: Khách hàng đến địa chỉ bán hàng.</p>
                <p>Bước 3: Khách hàng thanh toán và nhận hàng.</p>
                <p> </p>
                <h3><strong>Cách 2</strong>: Thanh toán sau (COD – giao hàng và thu tiền tận nơi)</h3>
                <p>Bước 1: Khách hàng tìm hiều thông tin về sản phẩm trên Daisan</p>
                <p>Bước 2: Khách hàng xác thực đơn hàng (điện thoại, tin nhắn, email).</p>
                <p>Bước 3: Nhà bán hàng xác thực thông tin khách hàng.</p>
                <p>Bước 4: Nhà bán hàng chuyển hàng.</p>
                <p>Bước 5: Khách hàng thanh toán và nhận hàng.</p>
                <p> </p>
                <h3><strong>Cách 3</strong>: Thanh toán online qua thẻ tín dụng, chuyển khoản</h3>
                <p>Bước 1: Khách hàng tìm hiểu thông tin về sản phẩm trên Daisan.</p>
                <p>Bước 2: Khách hàng xác thực đơn hàng (điện thoại, tin nhắn, email…).</p>
                <p>Bước 3: Nhà bán hàng xác thực thông tin khách hàng.</p>
                <p>Bước 4: Khách hàng thanh toán.</p>
                <p>Bước 5: Nhà bán hàng chuyển hàng.</p>
