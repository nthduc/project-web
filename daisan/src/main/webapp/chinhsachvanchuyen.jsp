...
<head>
    ...
    <title>DAISAN | Chính Sách Vận Chuyển</title>
...
<div style="padding: 25px 120px">
    <div style="padding: 10px 180px;" data-content-type="row" data-appearance="contained" data-element="main">
        <div class="container-680" data-enable-parallax="0" data-parallax-speed="0.5" data-background-images="{}"
            ...
            <hr>
            <div id="hcdetail">
                <p><strong>Daisan</strong> chỉ cung cấp dịch vụ trung gian cho phép người mua/ khách hàng và nhà bán
                    hàng
                    liên lạc
                    trực tiếp với nhau và thỏa thuận dịch vụ vận chuyển nên Công ty không có chính sách giao nhận,
                    vận chuyển. Kết quả giao dịch cuối cùng là hoàn toàn phụ thuộc vào việc thỏa thuận giữa người
                    mua
                    hàng và nhà bán hàng theo các hình thức phù hợp.</p>
                <p>Nhà bán hàng trên <strong>Daisan</strong> sẽ vận chuyển hàng trong thời gian thỏa thuận khi Người
                    mua
                    hàng
                    thực hiện đầy đủ các thủ tục đặt hàng.</p>
                <p><strong>Daisan</strong> khuyến cáo khách hàng phải đọc kỹ thông tin, hoặc gọi điện trực tiếp cho
                    Nhà bán
                    hàng để tìm hiểu về việc đổi trả hàng như thế nào trước khi quyết định mua hàng.</p>
                <p><strong>Daisan</strong> sẽ hỗ trợ khách hàng trong khả năng cho phép về việc đổi trả hàng hóa.
                </p>
            </div>
        </div>
    </div>
