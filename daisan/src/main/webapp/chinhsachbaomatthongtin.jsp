...
<head>
    ...
    <title>DAISAN | Chính sách bảo mật thông tin</title>
...
<div style="padding: 25px 120px">
    <div style="padding: 10px 180px;" data-content-type="row" data-appearance="contained" data-element="main">
        <div class="container-680" data-enable-parallax="0" data-parallax-speed="0.5" data-background-images="{}"
            ...
            <strong>CHÍNH SÁCH BẢO MẬT THÔNG TIN</strong></p>
            <ol style="text-align: justify;">
                <li><strong>Sự chấp thuận</strong></li>
            </ol>
            <p style="text-align: justify;">Khi bạn cung cấp thông tin cá nhân của mình cho Daisan.vn đồng nghĩa với
                việc
                bạn đồng ý với việc thông tin cá nhân của bạn sẽ được thu thập, sử dụng như được nêu trong chính
                sách này.
                Nếu bạn không đồng ý với chính sách này, bạn có thể dừng cung cấp cho chúng tôi các thông tin cá
                nhân hoặc
                dừng sử dụng các quyền như được nêu tại Mục 7 dưới đây. Chúng tôi bảo lưu quyền sửa đổi, bổ sung
                nhằm hoàn
                thiện đối với chính sách này vào bất kỳ thời điểm nào. Chúng tôi khuyến khích bạn thường xuyên xem
                lại Chính
                sách bảo mật thông tin để có được những cập nhật mới nhất đảm bảo bạn biết và thực hiện quyền quản
                lý thông
                tin cá nhân của mình.</p>
            <ol style="text-align: justify;" start="2">
                <li><strong>Mục đích thu thập</strong></li>
            </ol>
            <p style="text-align: justify;">Chúng tôi thu thập thông tin cá nhân chỉ cần thiết nhằm phục vụ cho các
                mục
                đích:</p>
            <p style="text-align: justify;">- Đơn hàng: để xử lý các vấn đề liên quan đến đơn đặt hàng của bạn;</p>
            <p style="text-align: justify;">- Duy trì tài khoản: để tạo và duy trình tài khoản của bạn với chúng
                tôi, bao
                gồm cả các chương trình khách hàng thân thiết hoặc các chương trình thưởng đi kèm với tài khoản của
                bạn;</p>
            <p style="text-align: justify;">- Dịch vụ người tiêu dùng, Dịch vụ chăm sóc khách hàng: bao gồm các phản
                hồi cho
                các yêu cầu, khiếu nại và phản hồi của bạn;</p>
            <p style="text-align: justify;">- Cá nhân hóa: Chúng tôi có thể tổng hợp dữ liệu được thu thập để có một
                cái
                nhìn hoàn chỉnh hơn về người tiêu dùng và từ đó cho phép chúng tôi phục vụ tốt hơn với sự cá nhân
                hóa mạnh
                hơn ở các khía cạnh, bao gồm nhưng không giới hạn: (i) để cải thiện và cá nhân hóa trải nghiệm của
                bạn trên
                sàn giao dịch thương mại điện tử Daisan.vn (ii) để cải thiện các tiện ích, dịch vụ, điều chỉnh chúng
                phù hợp
                với các nhu cầu được cá thể hóa và đi đến những ý tưởng dịch vụ mới (iii) để phục vụ bạn với những
                giới
                thiệu, quảng cáo được điều chỉnh phù hợp với sự quan tâm của bạn.</p>
            <p style="text-align: justify;">- An ninh: phục vụ các mục đích ngăn ngừa các hoạt động phá hủy tài
                khoản người
                dùng của khách hàng hoặc các hoạt động giả mạo khách hàng.</p>
            <p style="text-align: justify;">- Theo yêu cầu của pháp luật: tùy quy định của pháp luật vào từng thời
                điểm,
                chúng tôi có thể thu thập, lưu trữ và cung cấp theo yêu cầu của cơ quan nhà nước có thẩm quyền.</p>
            <ol style="text-align: justify;" start="3">
                <li><strong>Phạm vi thu thập</strong></li>
            </ol>
            <p style="text-align: justify;">Chúng tôi thu thập thông tin cá nhân của bạn khi:</p>
            <p style="text-align: justify;">- Bạn trực tiếp cung cấp cho chúng tôi: Đó là các thông tin cá nhân bạn
                cung cấp
                cho chúng tôi được thực hiện chủ yếu trên sàn giao dịch thương mại điện tử Daisan.vn bao gồm: họ
                tên, email,
                số điện thoại, địa chỉ, thông tin đăng nhập tài khoản bao gồm thông tin bất kỳ cần thiết để thiết
                lập tài
                khoản ví dụ như tên đăng nhập, mật khẩu đăng nhập, ID/địa chỉ đăng nhập và câu hỏi/trả lời an ninh.
            </p>
            <p style="text-align: justify;">- Từ những nguồn hợp pháp khác: Chúng tôi có thể sẽ thu thập thông tin
                cá nhân
                từ các nguồn hợp pháp khác.</p>
            <ol style="text-align: justify;" start="4">
                <li><strong>Thời gian lưu trữ</strong></li>
            </ol>
            <p style="text-align: justify;">Thông tin cá nhân của khách hàng sẽ được lưu trữ cho đến khi khách hàng
                có yêu
                cầu hủy bỏ hoặc khách hàng tự đăng nhập và thực hiện hủy bỏ. Trong mọi trường hợp thông tin cá nhân
                của
                khách hàng sẽ được bảo mật trên máy chủ của Daisan.vn</p>
            <ol style="text-align: justify;" start="5">
                <li><strong>Không chia sẻ thông tin cá nhân khách hàng</strong></li>
            </ol>
            <p style="text-align: justify;">Chúng tôi sẽ không cung cấp thông tin cá nhân của bạn cho bất kỳ bên thứ
                ba nào,
                trừ một số hoạt động cần thiết dưới đây:</p>
            <p style="text-align: justify;">- Các đối tác là bên cung cấp dịch vụ cho chúng tôi liên quan đến thực
                hiện đơn
                hàng và chỉ giới hạn trong phạm vi thông tin cần thiết cũng như áp dụng các quy định đảm bảo an
                ninh, bảo
                mật các thông tin cá nhân.</p>
            <p style="text-align: justify;">- Chúng tôi có thể sử dụng dịch vụ từ một nhà cung cấp dịch vụ là bên
                thứ ba để
                thực hiện một số hoạt động liên quan đến sàn giao dịch thương mại điện tử Daisan.vn và khi đó bên
                thứ ba này
                có thể truy cập hoặc xử lý các thông tin cá nhân trong quá trình cung cấp các dịch vụ đó. Chúng tôi
                yêu cầu
                các bên thứ ba này tuân thủ mọi luật lệ về bảo vệ thông tin cá nhân liên quan và các yêu cầu về an
                ninh liên
                quan đến thông tin cá nhân.</p>
            <p style="text-align: justify;">- Các chương trình có tính liên kết, đồng thực hiện, thuê ngoài cho các
                mục địch
                được nêu tại Mục 2 và luôn áp dụng các yêu cầu bảo mật thông tin cá nhân.</p>
            <p style="text-align: justify;">- Yêu cầu pháp lý: Chúng tôi có thể tiết lộ các thông tin cá nhân nếu
                điều đó do
                luật pháp yêu cầu và việc tiết lộ như vậy là cần thiết một cách hợp lý để tuân thủ các quy trình
                pháp lý.
            </p>
            <p style="text-align: justify;">- Chuyển giao kinh doanh (nếu có): trong trường hợp sáp nhập, hợp nhất
                toàn bộ
                hoặc một phần với công ty khác, người mua sẽ có quyền truy cập thông tin được chúng tôi lưu trữ, duy
                trì
                trong đó bao gồm cả thông tin cá nhân.</p>
            <ol style="text-align: justify;" start="6">
                <li><strong>An toàn dữ liệu</strong></li>
            </ol>
            <p style="text-align: justify;">Chúng tôi luôn nỗ lực để đảm bảo an toàn thông tin cá nhân của khách
                hàng, chúng
                tôi đã và đang thực hiện nhiều biện pháp an toàn, bao gồm:</p>
            <p style="text-align: justify;">- Bảo đảm an toàn trong môi trường vận hành: chúng tôi lưu trữ không tin
                cá nhân
                khách hàng trong môi trường vận hành an toàn và chỉ có nhân viên, đại diện và nhà cung cấp dịch vụ
                có thể
                truy cập trên cơ sở cần phải biết. Chúng tôi tuân theo các tiêu chuẩn ngành, pháp luật trong việc
                bảo mật
                thông tin cá nhân khách hàng.</p>
            <p style="text-align: justify;">- Trong trường hợp máy chủ lưu trữ thông tin bị hacker tấn công dẫn đến
                mất dữ
                liệu cá nhân khách hàng, chúng tôi sẽ có trách nhiệm thông báo vụ việc cho cơ quan chức năng để điều
                tra xử
                lý kịp thời và thông báo cho khách hàng được biết.</p>
            <p style="text-align: justify;">- Các thông tin thanh toán: được bảo mật theo tiêu chuẩn ngành.</p>
            <ol style="text-align: justify;" start="7">
                <li><strong>Quyền của khách hàng đối với thông tin cá nhân</strong></li>
            </ol>
            <p style="text-align: justify;">Khách hàng có quyền cung cấp thông tin cá nhân cho chúng tôi và có thể
                thay đổi
                quyết định đó vào bất cứ lúc nào. Khách hàng có quyền tự kiểm tra, cập nhật, điều chỉnh thông tin cá
                nhân
                của mình bằng cách đăng nhập vào tài khoản và chỉnh sửa thông tin cá nhân hoặc yêu cầu chúng tôi
                thực hiện
                việc này.</p>
            <ol style="text-align: justify;" start="8">
                <li><strong>Thông tin liên hệ</strong></li>
            </ol>
            <p style="text-align: justify;">Nếu bạn có câu hỏi hoặc bất kỳ thắc mắc nào về Chính sách này hoặc thực
                tế việc
                thu thập, quản lý thông tin cá nhân của chúng tôi, xin vui lòng liên hệ với chúng tôi theo cách sau:
            </p>
            <p style="text-align: justify;">+ Liên hệ hotline: 098.625.8282</p>
            <p style="text-align: justify;">+ Gửi email đến địa chỉ: <a
                    href="mailto:admin@daisan.vn">admin@daisan.vn</a>
            </p>
            <ol style="text-align: justify;" start="9">
                <li><strong>Đơn vị thu thập và quản lý thông tin</strong></li>
            </ol>
            <p style="text-align: justify;"><strong>CÔNG TY CỔ PHẦN XÂY DỰNG SẢN XUẤT VÀ THƯƠNG MẠI ĐẠI SÀN</strong>
            </p>
            <p style="text-align: justify;">Mã số thuế: 0103884103</p>
            <p style="text-align: justify;">Đăng ký lần đầu: ngày 26 tháng 05 năm 2009 </p>
            <p style="text-align: justify;">Đăng ký thay đổi lần thứ: 5 ngày 18 tháng 09 năm 2017</p>
            <p style="text-align: justify;">Địa chỉ: Số 88 Láng Hạ, Quận Đống Đa, HN</p>
            <p style="text-align: justify;">VPGD: Tầng 2 Số 8 Cát Linh, Đống Đa, Hà Nội</p>
            <p style="text-align: justify;">Số điện thoại: 098.625.8282</p>
            <p style="text-align: justify;">Email: <a href="mailto:admin@daisan.vn">admin@daisan.vn</a></p>
