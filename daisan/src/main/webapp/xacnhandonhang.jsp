...
<div class="body-content">
  <div class="container">
    <p style="color: #28d500; font-size: 18px;font-weight: 600; text-align: center;">Cám ơn bạn, đơn hàng của
      bạn đã được xác nhận</p>
      ...
      <div class="row signin-up checkout-container">
        ...
        <div class="col-md-7 col-sm-7 sign-in ">
          ...
          <div class="cart-infor">
            ...
            <p class="content">KP6, P.Linh Trung, TP.Thủ Đức, TPHCM</p>
            <br />
        ...
        <div class="col-md-5 col-sm-5 sign-in ">
          ...
          <div class="cart-infor">
            ...
            <p class="content">Gạch ốp lát</p>
            <br />
            <p class="title">Số lượng:</p>
            <p class="content">1</p>
            <br />
            <p class="title">Tổng cộng:</p>
            <p class="content">420.850đ</p>
          </div>
        </div>
