...
<head>
    ...
    <title>DAISAN | Xác Nhân Đơn Hàng</title>
                ...
                <div class="row">
                    <div class="col-md-5 order-md-2 mb-4">
                        ...
                        <ul class="list-group mb-4">
                            <input type="hidden" name="sanphamgiohang[1][sp_ma]" value="1">
                            <input type="hidden" name="sanphamgiohang[1][gia]" value="420.850">
                            <input type="hidden" name="sanphamgiohang[1][soluong]" value="1">

                            <li class="list-group-item d-flex justify-content-between lh-condensed">
                                <div>
                                    <h6 class="my-0">Gạch ốp lát Eurotile BST Vọng Cát 600*600mm VOC-H01</h6>
                                    <small class="text-muted">420.850 x 1</small>
                                </div>
                                <span class="text-muted">420.850</span>
                            </li>
                            ...
                            <!-- <li class="list-group-item d-flex justify-content-between lh-condensed">
                                    <div>
                                        <h6 class="my-0">Apple iPhone 5 16GB White</h6>1                                            <small class="text-muted">14990000.00 x 8</small>
                                    </div>
                    ...
                    <div class="col-md-6 order-md-1" style="margin-left: 80px;">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                ...
                                <input type="text" class="form-control" name="kh_ten" id="kh_ten"
                                       value="VD: Bùi Anh Tuấn" readonly="">
                            </div>
                            <div class="col-md-10" style="margin-top: 10px;">
                                <label for="kh_diachi" style="width: 150px;">Tỉnh/ thành phố </label>
                            ...
                            <div class="col-md-10" style="margin-top: 10px;">
                                <label for="kh_diachi" style="width: 150px;">Quận/ huyện </label>
                            ...
                            <div class="col-md-10" style="margin-top: 10px;">
                                <label for="kh_diachi" style="width: 150px;">Phường/ xã </label>
                            ...
                            <div class="col-md-10">
                                ...
                                <input type="text" class="form-control" name="kh_email" id="kh_email"
                                       value="buianhtuan@st.hcmuaf.edu,vn" readonly="">
                            </div>
