...
<%@ page import="java.util.List" %><%-- Created by IntelliJ IDEA. User: ACER Date: 8/12/2022 Time: 7:19 AM To change this template use File | Settings |
    File Templates. --%>
                                                            ...
                                                            %>
                                                                <tr>
                                                                    ...
                                                                    <td><a href="ecommerce-orders-chitietsanpham.jsp"
                                                                            class="text-body font-weight-medium"><%= order.getOrder_ID() %></a>
                                                                    </td>
                                                                    <td><%= order.getUser_ID()%></td>
                                                                    <td>
                                                                        <%= order.getDeliveryDate() %> <small class="text-muted"></small>
                                                                    </td>
                                                                    <td>
                                                                        <div>
                                                                    ...
                                                                    <td>
                                                                        <div><span class="badge badge-info"><%= order.getStatus() %></span></div>
                                                                    </td>
                                                                    <td>
