<%-- Created by IntelliJ IDEA. User: ACER Date: 8/12/2022 Time: 7:19 AM To change this template use File | Settings |
    File Templates. --%>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <form class="form-inline">
                                                                ...
                                                                <div class="form-group mx-sm-3 mb-2">
                                                                    <label for="status-select" class="mr-2">Trạng
                                                                        thái</label>
                                                                    <select class="custom-select" id="status-select">
                                                                        <option selected="">Chọn...</option>
                                                                        <option value="1">Đã thanh toán</option>
                                                                        <option value="2">Chưa thanh toán</option>
                                                                        <option value="3">Thanh toán khi giao hàng
                                                                        </option>
                                                                        <option value="4">Hủy đơn</option>
                                                                        <option value="5">Thanh toán không thành công
                                                                        </option>
                                                            ...
                                                            <div class="text-lg-right">
                                                                <button type="button"
                                                                    class="btn btn-danger mb-2 mr-2"><i
                                                                        class="mdi mdi-basket mr-1"></i> Thêm đơn hàng
                                                                    mới</button>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><a href="ecommerce-orders-chitietsanpham.jsp"
                                                                            class="text-body font-weight-medium">#MN2048</a>
                                                                    </td>
                                                                    <td>Phan Thị Duyên</td>
                                                                    <td>
                                                                        16 Tháng 4 2022 <small class="text-muted">10:29
                                                                            PM</small>
                                                                    </td>
                                                                    <td>
                                                                        <div>
                                                                            <span class="badge badge-light-success">Đã
                                                                                Thanh Toán</span>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <div><span class="badge badge-info">Đang Giao
                                                                                Hàng</span></div>
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="ecommerce-orders-chitietsanpham.jsp"
                                                                            class="text-body font-weight-medium">#MN2047</a>
                                                                    </td>
                                                                    <td>Nguyễn Tấn Dũng</td>
                                                                    <td>
                                                                        15 Tháng 3 2022 <small class="text-muted">09:34
                                                                            AM</small>
                                                                    </td>
                                                                    <td>
                                                                        <div><span
                                                                                class="badge badge-light-warning">Đang
                                                                                Chờ Xác
                                                                                Nhận</span></div>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <div><span class="badge badge-warning">Đang Xử
                                                                                Lý</span></div>
                                                                    </td>
                                                                    <td>
                                                                        <ul class="list-inline mb-0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="ecommerce-orders-chitietsanpham.jsp"
                                                                            class="text-body font-weight-medium">#MN2046</a>
                                                                    </td>
                                                                    <td>Bùi Anh Tuấn</td>
                                                                    <td>
                                                                        14 Tháng 3 2022 <small class="text-muted">11:09
                                                                            AM</small>
                                                                    </td>
                                                                    <td>
                                                                        <div><span class="badge badge-light-success">Đã
                                                                                Thanh
                                                                                Toán</span></div>
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="ecommerce-orders-chitietsanpham.jsp"
                                                                            class="text-body font-weight-medium">#MN2045</a>
                                                                    </td>
                                                                    <td>Đinh Thị Tuyết Mai</td>
                                                                    <td>
                                                                        13 Tháng 4 2022 <small class="text-muted">02:22
                                                                            PM</small>
                                                                    </td>
                                                                    <td>
                                                                        <div><span class="badge badge-light-success">Đã
                                                                    ...
                                                                    <td>
                                                                        <div><span class="badge badge-success">Đã Nhận
                                                                                Hàng</span></div>
                                                                    </td>
                                                                    <td>
                                                                        <ul class="list-inline mb-0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="ecommerce-orders-chitietsanpham.jsp"
                                                                            class="text-body font-weight-medium">#MN2044</a>
                                                                    </td>
                                                                    <td>Nguyễn Hoàng Minh</td>
                                                                    <td>
                                                                        12 Tháng 3 2022 <small class="text-muted">03:04
                                                                            PM</small>
                                                                    </td>
                                                                    <td>
                                                                        <div><span
                                                                                class="badge badge-light-danger">Thanh
                                                                                Toán Thất
                                                                                Bại</span></div>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <div><span class="badge badge-danger">Đã
                                                                                Hủy</span></div>
                                                                    </td>
                                                                    <td>
                                                                        <ul class="list-inline mb-0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="ecommerce-orders-chitietsanpham.jsp"
                                                                            class="text-body font-weight-medium">#MN2043</a>
                                                                    </td>
                                                                    <td>Nguyễn Hoàng Nghi</td>
                                                                    <td>
                                                                        11 Tháng 1 2022 <small class="text-muted">10:29
                                                                            PM</small>
                                                                    </td>
                                                                    <td>
                                                                        <div><span class="badge badge-light-success">Đã
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="ecommerce-orders-chitietsanpham.jsp"
                                                                            class="text-body font-weight-medium">#MN2042</a>
                                                                    </td>
                                                                    <td>Phan Thành Danh</td>
                                                                    <td>
                                                                        10 Tháng 3 2022 <small class="text-muted">09:14
                                                                            AM</small>
                                                                    </td>
                                                                    <td>
                                                                        <div><span
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="ecommerce-orders-chitietsanpham.jsp"
                                                                            class="text-body font-weight-medium">#MN2041</a>
                                                                    </td>
                                                                    <td>Trương Hữu Phước</td>
                                                                    <td>
                                                                        09 Tháng 3 2022 <small class="text-muted">01:25
                                                                            PM</small>
                                                                    </td>
                                                                    <td>
                                                                        <div><span class="badge badge-light-success">Đã
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="ecommerce-orders-chitietsanpham.jsp"
                                                                            class="text-body font-weight-medium">#MN2040</a>
                                                                    </td>
                                                                    <td>Nguyễn Văn Thân</td>
                                                                    <td>
                                                                        08 Tháng 3 2022 <small class="text-muted">04:24
                                                                            PM</small>
                                                                    </td>
                                                                    <td>
                                                                        <div><span class="badge badge-light-success">Đã
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="ecommerce-orders-chitietsanpham.jsp"
                                                                            class="text-body font-weight-medium">#MN2039</a>
                                                                    </td>
                                                                    <td>Trần Khánh Ly</td>
                                                                    <td>
                                                                        07 Tháng 8 2022 <small class="text-muted">02:24
                                                                            PM</small>
                                                                    </td>
                                                                    <td>
                                                                        <div><span
                                                    ...
                                                    <div class="row mt-4">
                                                        <div class="col-sm-6">
                                                            <div>
                                                                <h5 class="font-14 text-body">Showing orders 1 to 10 of
                                                                    112</h5>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
