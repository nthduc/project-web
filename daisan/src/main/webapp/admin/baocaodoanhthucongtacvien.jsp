<%-- Created by IntelliJ IDEA. User: ACER Date: 8/12/2022 Time: 7:13 AM To change this template use File | Settings |
    File Templates. --%>
                                            ...
                                            <div class="page-title-box">
                                                <div class="page-title-right">
                                                    <ol class="breadcrumb m-0">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Cộng
                                                                tác viên</a>
                                                        </li>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card-box">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-xl-3">
                                                            <div class="card-box">
                                                                ...
                                                                <h3>255</h3>
                                                                <p
                                                                    class="text-uppercase mb-1 font-13 font-weight-medium">
                                                                    Tổng đơn hàng
                                                                </p>
                                                            </div>
                                                        </div>
                                                ...
                                                <div id="tickets-table_wrapper"
                                                    class="dataTables_wrapper dt-bootstrap4 no-footer">
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-6">
                                                            <div class="dataTables_length" id="tickets-table_length">
                                                                <label>Show <select name="tickets-table_length"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <table
                                                                ...
                                                                aria-describedby="tickets-table_info"
                                                                style="width: 1180px;">
                                                                <thead class="bg-light">
                                                                    <tr role="row">
                                                                        <th class="font-weight-medium sorting_asc"
                                                                            tabindex="0" aria-controls="tickets-table"
                                                                            rowspan="1" colspan="1"
                                                                            style="width: 23.4px;" aria-sort="ascending"
                                                                            aria-label="ID: activate to sort column descending">
                                                                            ID</th>
                                                                        <th class="font-weight-medium sorting"
                                                                            tabindex="0" aria-controls="tickets-table"
                                                                            rowspan="1" colspan="1"
                                                                ...
                                                                <tbody class="font-14">
                                                                    ...
                                                                    <tr role="row" class="odd">
                                                                        <td tabindex="0" class="sorting_1"><b>#01</b>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr role="row" class="even">
                                                                        <td tabindex="0" class="sorting_1"><b>#02</b>
                                                                        </td>
                                                                        <td>
                                                                            <a href="javascript: void(0);"
                                                                                class="text-dark">
                                                                    ...
                                                                    <tr role="row" class="odd">
                                                                        <td tabindex="0" class="sorting_1"><b>#3</b>
                                                                        </td>
                                                                        <td>
                                                                            <a href="javascript: void(0);"
                                                                                class="text-dark">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-5">
                                                            <div class="dataTables_info" id="tickets-table_info"
                                                            ...
                                                            <div class="dataTables_paginate paging_simple_numbers"
                                                                ...
                                                                <ul class="pagination pagination-rounded">
                                                                    ...
                                                                    <li class="paginate_button page-item active"><a
                                                                            href="#" aria-controls="tickets-table"
                                                                    ...
                                                                    <li class="paginate_button page-item next"
                                                                        ...
                                                                        <a href="#" aria-controls="tickets-table"
