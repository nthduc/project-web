<%-- Created by IntelliJ IDEA. User: ACER Date: 8/12/2022 Time: 7:22 AM To change this template use File | Settings |
  File Templates. --%>
            ...
            <div class="content-page">
                      ...
                      <div class="page-title-box">
                        <div class="page-title-right">
                          <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Quản lí blog</li>
                          </ol>
                        </div>
                            ...
                            <div class="col-lg-4">
                              <div class="text-lg-right">
                                <button type="button" class="btn btn-danger mb-2 mr-2"><i
                                    class="mdi mdi-basket mr-1"></i> Thêm blog mới</button>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><a href="ecommerce-orders-chitietsanpham.jsp"
                                      class="text-body font-weight-medium">#DM01</a> </td>
                                  <td>Gạch ốp lát</td>
                                  <th>Nội dung</th>
                                  <th>Đức</th>
                                  <td>
                                ...
                                <tr>
                                  ...
                                  <td><a href="ecommerce-orders-chitietsanpham.jsp"
                                      class="text-body font-weight-medium">#DM02</a> </td>
              ...
              <footer class="footer">
                <div class="container-fluid">
                  <div class="row">
                    <div class="col-md-6">
                      2022 &copy; Baya admin by <a href="">Group 14</a>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="tab-pane show active" id="messages1">
                  <div>
                    <div class="inbox-widget">
                      ...
                      <hr>
                      <div class="inbox-item">
                        <div class="inbox-item-img"><img src="assets/images/users/avatar-7.jpg" class="rounded-circle"
                            alt=""> <i class="busy user-status"></i></div>
                      ...
                      <div class="inbox-item">
                        <div class="inbox-item-img"><img src="assets/images/users/avatar-10.jpg" class="rounded-circle"
                            alt=""> <i class="online user-status"></i></div>
                      ...
                      <div class="inbox-item">
                        <div class="inbox-item-img"><img src="assets/images/users/avatar-9.jpg" class="rounded-circle"
                            alt=""> <i class="away user-status"></i></div>
                      ...
                      <div class="text-center mt-2">
                        <a href="javascript:void(0);" class="text-muted"><i class="mdi mdi-spin mdi-loading mr-1"></i>
                          Load more </a>
                      </div>
