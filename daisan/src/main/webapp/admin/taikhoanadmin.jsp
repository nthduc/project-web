<%-- Created by IntelliJ IDEA. User: ACER Date: 8/12/2022 Time: 7:24 AM To change this template use File | Settings |
  File Templates. --%>
                  ...
                  <div class="row">
                    <div class="col-lg-4 col-xl-4">
                      <div class="card-box text-center">
                        <img src="https://i.imgur.com/GHS1690.png" class="rounded-circle avatar-xl img-thumbnail"
                          alt="profile-image">
                        ...
                        <div class="text-left mt-3">
                          ...
                          <p class="text-muted font-13 mb-3">
                            Chào mình là ${sessionScope.user.username} ^_^
                          </p>
                          <p class="text-muted mb-2 font-13"><strong>Họ tên :</strong> <span
                              class="ml-2">${sessionScope.user.fullname}</span></p>

                          <p class="text-muted mb-2 font-13"><strong>Số điện thoại :</strong><span
                              class="ml-2">${sessionScope.user.phone}</span></p>

                          <p class="text-muted mb-2 font-13"><strong>Email :</strong> <span
                              class="ml-2 ">${sessionScope.user.email}</span></p>

                          <p class="text-muted mb-1 font-13"><strong>Địa chỉ :</strong> <span
                              class="ml-2">${sessionScope.user.address}</span></p>
                        </div>
                      ...
                      <div class="card-box">
                        ...
                        <div class="pt-1">
                          ...
                          <div class="progress progress-sm m-0">
                            <div class="progress-bar bg-purple" role="progressbar" aria-valuenow="90" aria-valuemin="0"
                        ...
                        <div class="mt-2 pt-1">
                          ...
                          <div class="progress progress-sm m-0">
                            <div class="progress-bar bg-purple" role="progressbar" aria-valuenow="48" aria-valuemin="0"
                        ...
                        <div class="mt-2 pt-1">
                          ...
                          <div class="progress progress-sm m-0">
                            <div class="progress-bar bg-purple" role="progressbar" aria-valuenow="95" aria-valuemin="0"
                        ...
                        <div class="mt-2 pt-1">
                          ...
                          <div class="progress progress-sm m-0">
                            <div class="progress-bar bg-purple" role="progressbar" aria-valuenow="72" aria-valuemin="0"
                        ...
                        <div class="tab-content">
                          ...
                          <div class="tab-pane" id="settings">
                            <form>
                              ...
                              <h5 class="mb-3 text-uppercase bg-light p-2"><i class="mdi mdi-earth mr-1"></i>Mạng xã hội
                              </h5>
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
