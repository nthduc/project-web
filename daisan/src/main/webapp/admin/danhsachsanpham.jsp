                                        ...
                                        <div class="col-lg-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="row mb-2">
                                                        <div class="col-sm-6">
                                                            <a href="themsanpham.jsp" class="btn btn-danger mb-2"><i
                                                                    class="mdi mdi-plus-circle mr-1"></i> Thêm sản
                                                                phẩm</a>
                                                        </div>
                                                        <div class="col-sm-6">
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        ">
                                                                                ...
                                                                                <th style="width: 96.8px;"
                                                                                    ...
                                                                                    colspan="1" aria-label="Action">Tác
                                                                                    vụ
                                                                                </th>
                                                                            </tr>
                                                                        </thead>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12 col-md-5">
                                                                    <div class="dataTables_info"
                                                                        id="products-datatable_info" role="status"
                                                                        aria-live="polite">Hiển thị khách hàng từ 1 đến
                                                                        10
                                                                        của 12
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="dataTables_paginate paging_simple_numbers"
                                                                        ...
                                                                        <ul class="pagination pagination-rounded">
                                                                            <li class="paginate_button page-item previous disabled"
                                                                                id="products-datatable_previous"><a
                                                                                    href="#"
                                                                                    aria-controls="products-datatable"
