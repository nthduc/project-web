<%-- Created by IntelliJ IDEA. User: ACER Date: 8/12/2022 Time: 7:23 AM To change this template use File | Settings |
  File Templates. --%>
                      ...
                      <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-lg-4">
                              <div class="text-lg-right">
                                <button type="button" class="btn btn-danger mb-2 mr-2"><i
                                    class="mdi mdi-basket mr-1"></i> Thêm danh mục mới</button>
                            ...
                            <table class="table table-centered table-nowrap mb-0">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>Combo</td>
                                  <td>
                                    18 Tháng 3 2022 <small class="text-muted">11:09 AM</small>
                                  </td>
                          ...
                          <div class="row mt-4">
                            <div class="col-sm-6">
                              <div>
                                <h5 class="font-18 text-body">Showing orders 1 to 10 of 112</h5>
                              </div>
                            </div>
                            <div class="col-sm-6">
