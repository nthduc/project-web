                    ...
                    <div class="col-xl-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div>
                                    <button type="button"
                                            class="btn btn-block btn-lg btn-primary waves-effect waves-light">ĐANG CHỜ
                                        DUYỆT</button>
                                    <button type="button"
                                            class="btn btn-block btn-lg btn-primary waves-effect waves-light">ĐÃ PHÊ
                                        DUYỆT</button>
                                    <button type="button"
                                            class="btn btn-block btn-lg btn-primary waves-effect waves-light">ĐANG XỬ LÝ
                                        TẠI CH</button>
                                    <button type="button"
                                            class="btn btn-block btn-lg btn-primary waves-effect waves-light">ĐANG GIAO
                                        HÀNG</button>
                                    <button type="button"
                                            class="btn btn-block btn-lg btn-primary waves-effect waves-light">ĐÃ HOÀN
                                        THÀNH</button>
                                    <button type="button"
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="note-color text-center">Mặt hàng khách chọn mua được hiển thị tại đây <br>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="ttkh-b1">
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <div class="">
                                                <p class="sale_user_label">Người nhận: <span id="user_name"></span>
                                                </p>
                                                <p class="sale_user_label">Địa chỉ nhận: <span
                                                        id="user_address"></span></p>
                                                <p class="sale_user_label">Điện thoại: <span id="user_tel"></span>
                                                </p>
                    ...
                    <div class="col-xl-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="item_fee"></div>
                                <div>
                                    <p class="sale_user_label">Tổng hoá đơn: <span id="total_selected"
                                                                                   data-total_selected="0" data-cart-code=""></span></p>
                                </div>
                                <div id="cashback"></div>
                                <div>
                                    <p class="sale_user_label">Thanh toán: <span class="cart_payment_method"></span>
                                    </p>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body py-2 px-3 border-bottom border-light">
                                <div class="media py-1">
                                    <img src="assets/images/users/jeff.jpg" class="mr-2 rounded-circle" height="36"
                                         alt="Brandon Smith">
                                    <div class="media-body">
                                        <h5 class="mt-0 mb-0 font-15">
                                            <a href="contacts-profile.html" class="text-reset">Nguyễn Văn Tèo</a>
                                        </h5>
                            ...
                            <div class="card-body">
                                <ul class="conversation-list chat-app-conversation" data-simplebar="init"
                                    ...
                                    <div class="simplebar-wrapper" style="margin: 0px -15px;">
                                        ...
                                        <div class="simplebar-placeholder" style="width: auto; height: 900px;">
                                        </div>
                                    </div>
