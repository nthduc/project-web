<%-- Created by IntelliJ IDEA. User: ACER Date: 8/12/2022 Time: 7:26 AM To change this template use File | Settings |
  File Templates. --%>
                    ...
                    <div class="col-xl-4">
                      <div class="card text-center">
                        <div class="card-body">
                          ...
                          <button type="button" class="btn btn-success btn-xs waves-effect mb-2 waves-light">Vào trang
                            web
                            chính</button>
                        ...
                        <div class="card-body">
                          ...
                          <div class="media" id="cardCollpase1" class="pt-3 collapse show">
                            ...
                            <div class="media-body">
                              ...
                              <span class="font-13">18130047@st.hcmuaf.edu.vn <span class="badge badge-light-danger">
