<%@ page import="vn.edu.hcmuaf.fit.bean.UserBean" %>
    <%@ page import="java.util.List" %>
        <%@ page import="vn.edu.hcmuaf.fit.services.UserService" %><%-- Created by IntelliJ IDEA. User: ACER Date:
                8/12/2022 Time: 7:20 AM To change this template use File | Settings | File Templates. --%>
                                                        ...
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <table id="datatable-buttons"
                                                                    ...
                                                                    <tbody>
                                                                        <% List<UserBean> customers =
                                                                            UserService.getInstance().getCustomers();
