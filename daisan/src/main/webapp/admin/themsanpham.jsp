<%-- Created by IntelliJ IDEA. User: ACER Date: 8/12/2022 Time: 7:25 AM To change this template use File | Settings |
  File Templates. --%>
                              ...
                              <div class="tab-content b-0 mb-0">
                                          ...
                                          <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                              ...
                                              <select class="form-control select2 select2-hidden-accessible"
                                                id="product-category" data-select2-id="product-category" tabindex="-1"
                                                aria-hidden="true">
                                          ...
                                          <div class="card-body">
                                            ...
                                            <form action="/" method="post" class="dropzone" id="myAwesomeDropzone"
                                              ...
                                              <div class="dz-message needsclick">
                                                <p class="h1 text-muted"><i class="mdi mdi-cloud-upload"></i>
                                                </p>
                                ...
                                <ul class="list-inline mb-0 wizard" style="margin-top: 1rem;">
                                  <li class="previous list-inline-item">
                                    <a href="javascript: void(0);" class="btn btn-secondary">Trước</a>
                                  </li>
