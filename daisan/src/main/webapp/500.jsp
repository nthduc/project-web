                            ...
                            <ul class="categories-filter animate-dropdown">
                                <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown"
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="gachoplat.jsp">- Gạch ốp
                                            lát</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="daoplat.jsp">- Đá ốp lát</a>
                                        </li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="son.jsp">- Sơn nội thất &
                                            ngoại thất</a>
                                        </li>
                                        ...
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="vatlieutho.jsp">- Vật liệu
                                            thô</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="vattunganhda.jsp">- Vật tư
                                            ngành đá</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="vatlieumai.jsp">- Vật liệu
                                            mài & phụ kiện</a>
                                        </li>
        ...
        <div class="x-page inner-bottom-sm">
            <div class="row">
                <div class="col-md-12 x-text text-center">
                    ...
                    <a href="home.jsp"><i class="fa fa-home"></i> Trở về trang chủ</a>
                </div>
            </div><!-- /.row -->
        </div><!-- /.sigin-in-->
    </div><!-- /.container -->
