                            ...
                            <ul class="categories-filter animate-dropdown">
                                <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown"
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="gachoplat.html">- Gạch ốp
                                            lát</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="daoplat.html">- Đá ốp lát</a>
                                        </li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="son.html">- Sơn nội thất &
                                            ngoại thất</a>
                                        </li>
                                        ...
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="vatlieutho.html">- Vật liệu
                                            thô</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="vattunganhda.html">- Vật tư
                                            ngành đá</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="vatlieumai.html">- Vật liệu
                                            mài & phụ kiện</a>
                                        </li>
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            ...
                            <div class="clearfix cart-total">
                                <div class="pull-right"> <span class="text">Tổng tiền :</span><span class='price'>.850đ.</span>
                                </div>
                                <div class="clearfix"></div>
                                            ...
                                            <div class="yamm-content ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image"> <img
                                                            class="img-responsive" src="assets/images/sliders/slider3.png" alt="logo"
        ...
        <div class="x-page inner-bottom-sm">
            <div class="row">
                <div class="col-md-12 x-text text-center">
                    <h1>500</h1>
                    <p>Rất tiếc, lỗi máy chủ nội bộ. Vui lòng thử lại sau </p>
                    <form role="form" class="outer-top-vs outer-bottom-xs">
                        <input placeholder="Tìm kiếm" autocomplete="off">
                        <button class="  btn-default le-button">Tìm</button>
                    </form>
                    <a href="home.html"><i class="fa fa-home"></i> Trở về trang chủ</a>
                </div>
            </div><!-- /.row -->
        </div><!-- /.sigin-in-->
    </div><!-- /.container -->
