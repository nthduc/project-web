                        ...
                        <c:choose>
                            ...
                            <li><a href="thongtintaikhoan.jsp"><i class="icon fa fa-user"></i>${sessionScope.acc.fullname}</a>
                                ...
                                <c:otherwise>
                                        ...
                                        <li><a href="ShowCart?name=${sessionScope.cart}"><i class="icon fa fa-shopping-cart"></i>Giỏ hàng</a></li>
                                                    ...
                                                    <div class="action">
                                                        <ul class="list-unstyled" style="margin-right: 30px">
                                                            <li class="add-cart-button btn-group" style="margin-right: 30px">
                                                               <a class="btn btn-primary" href="AddCart?id=${p.id}"><i class="fa fa-shopping-cart" ></i> Thêm vào giỏ hàng</a>
