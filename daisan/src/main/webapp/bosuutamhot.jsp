    ...
    <div class='row'>
          ...
          <nav class="yamm megamenu-horizontal">
            <ul class="nav">
              ...
              <li class="dropdown menu-item"> <a href="vatlieumai.html">
                <i><img src="assets/images/icons-products/vat-lieu-mai.png"
                        style="height: 24px; width: 24px" /></i>
                ...
                <div class="accordion">
                  <div class="accordion-group">
                    <div class="accordion-heading"> <a href="#collapseOne"
                                                       data-toggle="collapse" class="accordion-toggle collapsed"> Gạch ốp
                      lát </a> </div>
                    <!-- /.accordion-heading -->
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading"> <a href="#collapseTwo"
                                                       data-toggle="collapse" class="accordion-toggle collapsed"> Đá ốp lát
                    </a> </div>
                    <!-- /.accordion-heading -->
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading"> <a href="#collapseThree"
                                                       data-toggle="collapse" class="accordion-toggle collapsed"> Sơn nội
                      thất & ngoại thất</a> </div>
                    <!-- /.accordion-heading -->
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading"> <a href="#collapseFour"
                                                       data-toggle="collapse" class="accordion-toggle collapsed"> Sàn gỗ và
                      phụ kiện </a> </div>
                    <!-- /.accordion-heading -->
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading"> <a href="#collapseFive"
                                                       data-toggle="collapse" class="accordion-toggle collapsed"> Tấm ốp
                      tường </a> </div>
                    <!-- /.accordion-heading -->
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading"> <a href="#collapseSix"
                                                       data-toggle="collapse" class="accordion-toggle collapsed"> Vật liệu
                      thô </a> </div>
                    <!-- /.accordion-heading -->
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading"> <a href="#collapseSevent"
                                                       data-toggle="collapse" class="accordion-toggle collapsed"> Vật tư
                      ngành đá </a> </div>
                    <!-- /.accordion-heading -->
                    <div class="accordion-body collapse" id="collapseSevent"
                         style="height: 0px;">
                      <div class="accordion-inner">
                        <ul>
                          <li><a href="#">Đá cắt đá mài</a></li>
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading"> <a href="#collapseEight"
                                                       data-toggle="collapse" class="accordion-toggle collapsed"> Vật liệu
                      mài & phụ kiện </a> </div>
                    <!-- /.accordion-heading -->
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading"> <a href="#collapseNine"
                                                       data-toggle="collapse" class="accordion-toggle collapsed"> Cửa & cửa
                      sổ </a> </div>
                    <!-- /.accordion-heading -->
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading"> <a href="#collapseTen"
                                                       data-toggle="collapse" class="accordion-toggle collapsed"> Nẹp </a>
                    </div>
                    <!-- /.accordion-heading -->
            ...
            <div class="sidebar-widget wow fadeInUp">
              ...
              <div class="sidebar-widget-body m-t-10">
                <div class="price-range-holder"> <span class="min-max"> <span
                        class="pull-left">20.000đ</span> <span
      ...
      <div class='col-md-9'>
        ...
        <div id="category" class="category-carousel hidden-xs">
          <div class="item">
            <div class="image"> <img style="filter:brightness(70%);"
                                     src="assets/images/banners/banner-vatlieu.png" alt="" class="img-responsive"> </div>
          ...
          <div class="row">
              ...
              <div class="filter-tabs">
                <ul id="filter-tabs" class="nav nav-tabs nav-tab-box nav-tab-fa-icon">
                  ...
                  <li><a data-toggle="tab" href="#list-container"><i
                          class="icon fa fa-th-list"></i>Danh sách</a></li>
                </ul>
              </div>
              <!-- /.filter-tabs -->
            </div>
                  ...
                  <div class="fld inline">
                    <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                      <button data-toggle="dropdown" type="button"
                              class="btn dropdown-toggle"> Mặc định <span class="caret"></span>
                      </button>
            ...
            <div class="col col-sm-6 col-md-4 text-right">
              <div class="pagination-container">
                <ul class="list-inline list-unstyled">
                  <li style="width: 30px;" class="prev"><a href="#"><i
                  ...
                  <li style="width: 30px;" class="next"><a href="#"><i
                ...
                <div class="row">
                    ...
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          ...
                          <div class="product-price"> <span class="price"> 89.000đ
                                                            </span> <span
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="chitietsanpham.html"><img
                                  src="assets/images/products/vatlieutho/ximang/hoanglong.png"
                                  alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="chitietsanpham.html">Xi măng Hoàng Long</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> 89.000đ
                                                            </span> <span
                                  class="price-before-discount">95.000đ</span> </div>
                          <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="product">
                      <div class="product-image">
                        <div class="image"> <a href="chitietsanpham.html"><img
                                src="assets/images/products/vatlieutho/ximang/hoanglong.png" alt=""></a>
                        </div>
                        <!-- /.image -->
                      ...
                      <div class="product-info text-left">
                        ...
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>
                        <div class="product-price"> <span class="price"> 89.000đ </span>
                          <span class="price-before-discount">92.000đ</span> </div>
                        <!-- /.product-price -->
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="product">
                      ...
                      <div class="product-info text-left">
                        <h3 class="name"><a href="chitietsanpham.html">Xi Măng Hà Tiên</a></h3>
                        <div class="rating rateit-small"></div>
                        <div class="description"></div>
                        <div class="product-price"> <span class="price"> 90.000đ </span>
                          <span class="price-before-discount">90.000đ</span> </div>
                        <!-- /.product-price -->
                      ...
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          ...
                          <div class="product-price"> <span class="price"> 89.000đ
                                  ...
                                  class="price-before-discount">92.000đ</span> </div>
                          <!-- /.product-price -->
                      ...
                      <div class="row product-list-row">
                        ...
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="chitietsanpham.html">Floral Print
                              Buttoned</a></h3>
                            <div class="rating rateit-small"></div>
