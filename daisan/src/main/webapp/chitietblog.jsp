...
<head>
    ...
    <title>Daisan | Chi tiết Blog</title>
                                    ...
                                    <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown"
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                                       href="gachoplat.html">- Gạch ốp lát</a>
                                            </li>
                                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                                       href="daoplat.html">- Đá ốp lát</a>
                                            </li>
                                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                                       href="son.html">- Sơn nội thất & ngoại
                                                thất</a>
                                            </li>
                                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                                       href="sango.html">- Sàn gỗ và phụ
                                                kiện</a></li>
                                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                                       href="tamoptuong.html">- Tấm ốp
                                                tường</a></li>
                                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                                       href="vatlieutho.html">- Vật liệu
                                                thô</a></li>
                                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                                       href="vattunganhda.html">- Vật tư ngành
                                                đá</a></li>
                                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                                       href="category.html">- Vật liệu mài &
                                                phụ kiện</a></li>
                                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                                       href="cuaso.html">- Cửa & cửa sổ,
                                                bản lề & phụ
                                                kiện</a></li>
                                            <li role="presentation"><a role="menuitem" tabindex="-1"
            ...
            <div class="blog-page">
                <div class="col-md-9">
                    <div class="blog-post wow fadeInUp">
                        <h1>TRẺ TRUNG & LÃNG MẠN</h1>
                        <span class="author">Đức</span>
                        <span class="review">6 Bình luận</span>
                        <span class="date-time">14/06/2022 10.00AM</span>
                        <img class="img-responsive" src="assets/images/blog/1-1.jpeg" alt=""
                             style="margin-top: 15px;">

                        <p>Phòng khách cho đôi bạn trẻ trong không gian mở mang phong cách nhẹ nhàng. Đủ riêng tư
                            cho cuộc sống vợ chồng lãng mạn, để không ngừng thăng hoa cùng vũ điệu của ánh sáng và
                            màu sắc ở khắp xung quanh.</p>
                        <img class="img-responsive" src="assets/images/blog/1-2.jpeg" alt=""
                             style="margin-top: 15px;">
                        <p>Sofa HACKMAN với kiểu dáng cổ điển, nét cong dịu dàng của tay vịn và chân ghế có bánh xe
                            kim loại chắc chắn, cùng chất liệu vỏ bọc polyester mềm mại mang đến sự thoải mái tối đa
                            khi ngồi.</p>
                        <img class="img-responsive" src="assets/images/blog/1-3.jpeg" alt="" style="margin-top: 15px;
	width: 810px;">
                    ...
                    <div class="blog-post-author-details wow fadeInUp">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <span class="author-job">CEODaisan</span>
                    ...
                    <div class="blog-review wow fadeInUp">
                        <div class="row">
                            ...
                            <div class="post-load-more col-md-12"><a class="btn btn-upper btn-primary" href="#">Xem
                                Thêm</a></div>
                        </div>
                    </div>
                    <div class="blog-write-comment outer-bottom-xs outer-top-xs">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <form class="register-form" role="form">
                                    <div class="form-group">
                                        <label class="info-title" for="exampleInputName">Tên của bạn
                                            <span>*</span></label>
                            ...
                            <div class="col-md-12 outer-bottom-small m-t-20">
                                <button type="submit"
                                        class="btn-upper btn btn-primary checkout-page-button">Đăng</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 sidebar">
                    ...
                    <div class="sidebar-module-container">
                        ...
                        <div class="home-banner outer-top-n outer-bottom-xs">
                            <!-- <img src="assets/images/blank.gif" alt="Image" style="width: 263px;"> -->
                        </div>
                            ...
                            <div class="tab-content" style="padding-left:0">
                                <div class="tab-pane active m-t-20" id="popular">
                                    <div class="blog-post inner-bottom-30 ">
                                        <img class="img-responsive" src="assets/images/blog/1.jpeg" alt="">
                                        <h4><a href="chitietblog.html">TRẺ TRUNG & LÃNG MẠN</a></h4>
                                        <span class="review">6 Bình luận</span>
                                        <span class="date-time">1 năm trước </span>
                                        <p>Không gian trăng mật cho cặp đôi mới cưới với thiết kế giản đơn mà rạng
                                            rỡ màu hạnh phúc.</p>

                                    </div>
                                    <div class="blog-post">
                                        <img class="img-responsive" src="assets/images/blog-post/1-1-1024x493.jpg"
                                             alt="">
                                        <h4><a href="chitietblog.html">GIA ĐÌNH NHỎ HẠNH PHÚC</a></h4>
                                        <span class="review">3 Bình luận</span>
                                        <span class="date-time">1 năm trước</span>
                                        <p>Ngôi nhà đủ đầy sự ân cần và dịu dàng sắp xếp cho con trẻ niềm vui hạnh
                                            phúc trong suốt khoảng trời tuổi thơ. Nơi có tiếng bố ân cần trò chuyện,
                                            có tay mẹ dịu dàng sắp xếp, cho con nụ cười hồn nhiên với bữa điểm tâm
                                            ngon lành.</p>
                                ...
                                <div class="tab-pane m-t-20" id="recent">
                                    <div class="blog-post inner-bottom-30">
                                        <img class="img-responsive"
                                             src="assets/images/blog-post/CATALOGE-officetel_2_R1.jpg" alt="">
                                        <h4><a href="chitietblog.html">PHONG CÁCH & ĐA NĂNG</a></h4>
                                        <span class="review">2 Comments</span>
                                        <span class="date-time">5/06/2020</span>
                                        <p>Những tiện nghi hiện đại trong không gian tập trung hiệu quả & thư giãn
                                            tối đa cho căn hộ office-tel đa chức năng.</p>

                                    </div>
                                    <div class="blog-post">
                                        <img class="img-responsive"
                                             src="assets/images/blog-post/CATALOGE-young-couple_4a_R-21.jpg" alt="">
                                        <h4><a href="chitietblog.html">BST PHÒNG KHÁCH - TRỌN VẸN TỪNG KHOẢNH
                                            KHẮC</a></h4>
                                        <span class="review">6 Bình luânh</span>
                                        <span class="date-time">10/07/2020</span>
                                        <p>Không chỉ là nơi tiếp đón, phòng khách còn là không gian sum vầy và thư
                                            giãn cho mọi thành viên trong gia đình. Hãy đểDaisan chăm chút trọn vẹn
                                            từng khoảnh khắc gặp gỡ, giờ nghỉ ban trưa hay phút quây quần buổi tối
                                            của gia đình bạn.</p>
