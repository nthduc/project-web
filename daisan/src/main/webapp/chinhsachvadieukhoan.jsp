...
<head>
    ...
    <title>DAISAN | Chính Sách và Điều Khoản</title>
...
<div style="padding: 25px 120px">
    <div style="padding: 10px 180px;" data-content-type="row" data-appearance="contained" data-element="main">
        <div class="container-680" data-enable-parallax="0" data-parallax-speed="0.5" data-background-images="{}"
            ...
            <strong>ĐIỀU KIỆN VÀ ĐIỀU KHOẢN</strong></p>
            <p style="text-align: justify;">Sàn thương mại điện tử <strong>Daisan.vn </strong>do Công ty Đại Sàn
                phát triển
                với tên miền Sàn giao dịch là: www.daisan.vn (gọi tắt là Sàn TMĐT Daisan.vn).</p>
            <ul style="text-align: justify;">
                <li>Người bán hàng: là chủ sở hữu của hàng hóa/dịch vụ hoặc người được chủ sở hữu ủy quyền cung cấp
                    hàng
                    hóa/dịch vụ trên các gian hàng của <strong>Daisan </strong></li>
                <li>Người mua hàng: là thành viên hoặc không phải thành viên nhưng cung cấp đầy đủ các thông tin cá
                    nhân
                    theo yêu cầu của <strong>Daisan </strong>có nhu cầu mua hàng hóa/dịch vụ trên <strong>Daisan
                    </strong>
                </li>
                <li>Sản phẩmlà hàng hóa, dịch vụ được Nhà bán hàng/ Người bán cung cấp thông qua Sàn TMĐT
                    <strong>Daisan
                    </strong></li>
                <li>Thành viên là các Khách hàng/ Người mua, Nhà bán hàng/ Người bán có đăng ký tài khoản sử dụng
                    trên
                    <strong>Daisan </strong>
                </li>
                <li>Thành viên phải đăng ký kê khai ban đầu các thông tin cá nhân liên quan, được Ban quản lý Sàn
                    TMĐT
                    <strong>Daisan</strong> chính thức công nhận và được phép sử dụng dịch vụ do Sàn giao dịch TMĐT.
                </li>
                <li>Khi đăng ký là thành viên của <strong>Daisan</strong>, thành viên hiểu rằng:</li>
                <li>+ Thành viên có thể tạo một tài khoản cá nhân của mình để sử dụng.</li>
                <li>+ Thành viên có thể mua sản phẩm, dịch vụ theo đúng giá và quy chuẩn theo đúng cam kết của
                    thương nhân
                    hợp pháp đã công bố trên Sàn.</li>
            </ul>
            <ol style="text-align: justify;">
                <li><strong>Phạm vi áp dụng </strong></li>
            </ol>
            <p style="text-align: justify;">Điều Khoản Và Điều Kiện sẽ được áp dụng cho khách hàng:</p>
            <ul style="text-align: justify;">
                <li>Mua sản phẩm bán trên <strong>Daisan </strong></li>
                <li>Có nhu cầu được giao sản phẩm đến các địa điểm phù hợp với Chính sách giao hàng.</li>
            </ul>
            <p style="text-align: justify;">Khách hàng tại Điều Khoản Và Điều Kiện này bao gồm: mọi cá nhân từ đủ 15
                tuổi
                trở lên, có năng lực hành vi dân sự phù hợp để thực hiện giao dịch thông qua Daisan và mọi tổ chức
                được
                thành lập và hoạt động hợp pháp theo quy định của pháp luật Việt Nam (gọi là “Khách Hàng”)</p>
            <ol style="text-align: justify;" start="2">
                <li><strong>Lĩnh vực hoạt động</strong></li>
            </ol>
            <ul style="text-align: justify;">
                <li>Mua bán hàng hóa liên quan đến các ngành như công nghiệp và xây dựng, làm đẹp, sách, ô tô,... mà
                    pháp
                    luật cho phép.</li>
                <li>Việc kinh doanh hàng hóa, dịch vụ trên website thương mại điện tử còn phải chịu sự điều chỉnh
                    của các
                    quy định pháp luật liên quan tới hàng hóa, dịch vụ đó.</li>
            </ul>
            <ol style="text-align: justify;" start="3">
                <li><strong>Hợp đồng, giá cả, hóa đơn</strong></li>
            </ol>
            <p style="text-align: justify;">+ Xác lập (hình thành) hợp đồng tham gia mở gian hàng: Hợp đồng giữa
                <strong>Daisan </strong>và khách hàng chỉ xác lập và có hiệu lực kể từ thời điểm bắt đầu từ ngày kí
                hợp đồng
                giữa hai bên.
            </p>
            <p style="text-align: justify;">+ Giá cả, hóa đơn GTGT và thanh toán</p>
            <ul style="text-align: justify;">
                <li>Giá của sản phẩm có thể đã bao gồm hoặc chưa bao gồm thuế giá trị gia tăng và được mô tả cụ thể
                    trên
                    trang giới thiệu sản phẩm. Trong mọi trường hợp, giá của sản phẩm không bao gồm phí vận chuyển.
                    Chi phí
                    vận chuyển được quy định cụ thể tại chính sách giao hàng của từng gian hàng.</li>
                <li>Khách hàng có quyền yêu cầu xuất hóa đơn GTGT và được nhận hóa đơn GTGT hợp lệ từ Daisan hoặc
                    nhà cung
                    cấp bằng cách liên hệ trực tiếp với nhà cung cấp</li>
            </ul>
            <ol style="text-align: justify;" start="4">
                <li><strong>Chăm sóc khách hàng và xử lý khiếu nại</strong></li>
            </ol>
            <p style="text-align: justify;"><strong>Daisan </strong>và nhà bán hàng có trách nhiệm tiếp nhận khiếu
                nại và hỗ
                trợ người mua liên quan đến giao dịch tại website Daisan.vn </p>
            <p style="text-align: justify;">Khi phát sinh tranh chấp, <strong>Daisan </strong>đề cao giải pháp
                thương lượng,
                hòa giải giữa các bên nhằm duy trì sự tin cậy của Khách hàng vào chất lượng dịch vụ của
                <strong>Daisan
                </strong>và thực hiện theo các bước sau:</p>
            <ul style="text-align: justify;">
                <li>Bước 1: Khách hàng khiếu nại về hàng hóa của Nhà bán hàng qua email admin@daisan.vn hoặc Hotline
                    098.625.8282</li>
                <li>Bước 2: Bộ phận Chăm sóc khách hàng của <strong>Daisan </strong>sẽ tiếp nhận các khiếu nại của
                    khách
                    hàng, tùy theo tính chất và mức độ của khiếu nại thì bên <strong>Daisan </strong>sẽ có những
                    biện pháp
                    cụ thể hỗ trợ khách hàng giải quyết tranh chấp đó.</li>
                <li>Bước 3: <strong>Daisan </strong>yêu cầu khách hàng và Nhà bán hàng phải cung cấp đủ các thông
                    tin liên
                    quan đến giao dịch, sản phẩm.</li>
                <li>Bước 4: Trong trường hợp nằm ngoài khả năng và thẩm quyền của <strong>Daisan </strong>thì ban
                    quản trị
                    sẽ yêu cầu khách hàng đưa vụ việc này ra cơ quan có thẩm quyền giải quyết theo pháp luật.</li>
            </ul>
            <p style="text-align: justify;"><strong>Khách hàng gửi khiếu nại đến địa chỉ:</strong></p>
            <p style="text-align: justify;">CÔNG TY CỔ PHẦN XÂY DỰNG SẢN XUẤT VÀ THƯƠNG MẠI ĐẠI SÀN</p>
            <ul style="text-align: justify;">
                <li>Địa chỉ: Số 88 Láng Hạ, Quận Đống Đa, HN</li>
                <li>Văn phòng giao dịch: Tầng 2 Số 8 Cát Linh, Đống Đa, Hà Nội</li>
                <li>Điện thoại: 098.625.8282</li>
                <li>Email: admin@daisan.vn</li>
            </ul>
        </div>
    </div>
</div>
