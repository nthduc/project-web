        ...
        <div class="contact-page">
            <div class="row">
                ...
                <div class="col-md-12 contact-map outer-bottom-vs">
                    <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31346.777421984974!2d106.77124777642109!3d10.86117670198758!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3175276398969f7b%3A0x9672b7efd0893fc4!2zxJDhuqFpIEjhu41jIE7DtG5nIEzDom0!5e0!3m2!1svi!2s!4v1604159683286!5m2!1svi!2s"
                ...
                <div class="col-md-9 contact-form">
                    ...
                    <div class="col-md-12 outer-bottom-small m-t-20">
                        <button type="submit" class="btn-upper btn btn-primary thanhtoan-page-button">Gửi </button>
                    </div>
                </div>
                <div class="col-md-3 contact-info">
                    ...
                    <div class="clearfix address">
                        ...
                        <span class="contact-span">Khu phố 6, phường Linh Trung, quận Thủ Đức, TP.HCM</span>
                    </div>
                    <div class="clearfix phone-no">
                        <span class="contact-i"><i class="fa fa-mobile"></i></span>
                        <span class="contact-span">+(84)(96)235-1043</span>
                    </div>
                    <div class="clearfix email">
                        <span class="contact-i"><i class="fa fa-envelope"></i></span>
                        <span class="contact-span"><a href="#">nguyenthaiduc0212@gmail.com</a></span>
                    </div>
                </div>
            </div><!-- /.contact-page -->
        </div><!-- /.row -->
            ...
            <div class="container">
                <div class="row">
                            ...
                            <ul class="toggle-footer">
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body"> <span><a
                                            href="#">nguyenthaiduc0212@gmail.com</a></span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        ...
                        <div class="module-body">
                            <ul class='list-unstyled'>
                                <li class="first"><a title="Thanh toán" href="huongdanthanhtoan.html">Hướng dẫn
                                    thanh
                                    toán</a></li>
                                ...
                                <li><a title="Vận chuyển" href="chinhsachvanchuyen.html">Phương thức vận chuyển</a>
                                </li>
                                <li class="last"><a title="Bảo mật thông tin"
                                                    href="chinhsachbaomatthongtin.html">Bảo
                                    mật thông tin</a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="footer-info p-3 p-md-0">
                    <div class="row row-sm justify-content-center">
                        ...
                        <div class="col-xl-4">
                            ...
                            <p class="mb-2">Công Ty Cổ phần Đại Sàn. GPĐKKD: 0103884103 do sở KH &amp; ĐT TP Hà Nội
                                cấp lần đầu ngày 29/06/2009.</p>
