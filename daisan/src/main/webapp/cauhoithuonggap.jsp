...
<head>
    ...
    <title>DAISAN | Câu Hỏi Thường Gặp</title>
        ...
        <div class="container-680" data-enable-parallax="0" data-parallax-speed="0.5" data-background-images="{}"
            ...
            <div id="hcdetail">
                <p><span style="font-size: 14px; line-height: 1.5;"><span
                        style="color: #ff0000;"><strong>Daisan.vn</strong></span> Cung cấp dịch vụ Sàn giao dịch
                            thương
                            mại
                            điện tử cho phép tổ chức, cá nhân tạo gian hàng để mua bán hàng hóa, dịch vụ trực
                            tuyến.</span></p>
                <p><span style="font-size: 14px; line-height: 1.5;"><span
                        style="color: #ff0000;"><strong>Daisan.vn</strong></span> Được xây dựng nhằm hỗ trợ tối
                            đa cho
                            khách
                            hàng muốn tìm kiếm thông tin trực tuyến về nhiều loại hàng hóa, dịch vụ khác nhau hoặc có
                            nhu cầu
                            mua
                            sắm hàng hóa trực tuyến.</span></p>
                <p><span style="font-size: 14px; line-height: 1.5;"><span
                        style="color: #ff0000;"><strong>Daisan.vn</strong></span> Ra đời với mong muốn bắt kịp
                            xu hướng
                            công
                            nghệ, hoài bão trở thành sàn Thương mại điện tử lớn mạnh tiên phong và dẫn đầu trên lĩnh vực
                            xây
                            dựng
                            tại Việt Nam, xa hơn là khu vực và thế giới.</span></p>
                <p><span style="font-size: 14px; line-height: 1.5;">Sứ mệnh của <span
                        style="color: #ff0000;"><strong>Daisan.vn</strong></span> là trở thành Sàn giao dịch
                            thương mại
                            điện
                            tử tin cậy trong thị trường Thương mại điện tử, là cầu nối thương mại, kết nối giữa người
                            bán và
                            người
                            mua, giữa doanh nghiệp với doanh nghiệp, 100% sản phẩm là hàng chính hãng.Tại đây, khách
                            hàng hoàn
                            toàn
                            có thể mua mọi sản phẩm đến từ nhiều Thương hiệu, Nhà cung cấp khác nhau để hoàn thiện công
                            trình
                            của
                            bạn.</span></p>
                <p><span style="font-size: 14px; line-height: 1.5;"><strong>Giá trị cốt lõi:</strong></span></p>
                <p><span style="font-size: 14px; line-height: 1.5;">Đại Sàn cam kết luôn trung thành với những giá
                            trị cốt
                            lõi
                            của mình để ghi dấu trong tâm trí khách hàng là thương hiệu đáng tin nhất trên thị trường
                            xây dựng
                            hiện
                            nay. Hệ thống giá trị bao gồm:</span></p>
                <ul>
                    <li><span style="font-size: 14px; line-height: 1.5;">Số lượng sản phẩm và dịch vụ lớn nhất: vật
                                liệu xây
                                dựng, phụ gia xây dựng, vật liệu hoàn thiện, thiết bị vệ sinh, máy móc hỗ trợ,…đa dạng
                                chủng
                                loại,
                                mẫu mã, giá thành.</span></li>
                    <li><span style="font-size: 14px; line-height: 1.5;">Nền tảng công nghệ hiện đại, giao dịch
                                thuận tiện,
                                nhanh chóng.</span></li>
                    <li><span style="font-size: 14px; line-height: 1.5;">Chăm sóc khách hàng 24/7 với đội ngũ nhân
                                viên
                                trang bị
                                đầy đủ kiến thức và kỹ năng.</span></li>
                    <li><span style="font-size: 14px; line-height: 1.5;">Thanh toán an toàn, bảo mật; tốc độ chuyển
                                giao
                                hàng
                                hóa nhanh chóng; chứng từ hồ sơ đảm bảo hợp lệ, đúng quy chuẩn,…</span></li>
                </ul>
                <p> </p>
                <p><strong><span style="font-size: 14px; line-height: 1.5;"><span
                        style="color: #ff0000;">Daisan.vn</span>
                ...
                <p><span style="color: #808080;"><strong>Tên công ty: Công ty cổ phần Xây dựng Sản xuất và Thương
                                mại Đại
                                Sàn</strong></span></p>
                ...
                <p><span style="color: #808080;"><strong>VPGD: Tầng 2 Số 8 Cát Linh, Đống Đa, Hà Nội</strong></span>
                </p>
                ...
                <p><span style="color: #808080;"><strong>Đăng ký lần đầu: ngày 26 tháng 05 năm 2009 </strong></span>
                </p>
